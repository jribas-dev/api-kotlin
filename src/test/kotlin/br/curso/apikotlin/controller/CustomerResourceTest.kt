...
class CustomerResourceTest {
    ...
    fun `should create a customer and return 201 status`() {
        ...
        mockMvc.perform(
            ...
            .andExpect(MockMvcResultMatchers.jsonPath("$.lastName").value("Jobs"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.cpf").value("28475934625"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.email").value("testjobs@email.com"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.income").value("1000.11"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.zipCode").value("000000"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.street").value("Jobs Street, 123"))
    ...
    fun `should not find customer with invalid id and return 400 status`() {
        ...
        mockMvc.perform(
            ...
            .andExpect(
                MockMvcResultMatchers.jsonPath("$.exception")
                    .value("class br.curso.apikotlin.exception.BusinessException")
            )
            .andExpect(MockMvcResultMatchers.jsonPath("$.details[*]").isNotEmpty)
            .andDo(MockMvcResultHandlers.print())
    }
    ...
    fun `should update a customer and return 200 status`() {
        ...
        mockMvc.perform(
            ...
            .andExpect(MockMvcResultMatchers.jsonPath("$.lastName").value("JobsUpdate"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.cpf").value("28475934625"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.email").value("testjobs@email.com"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.income").value("5000.33"))
    ...
    private fun builderCustomerDto(
        ...
        email: String = "testjobs@email.com",
        income: BigDecimal = BigDecimal.valueOf(1000.11),
        password: String = "1234",
        zipCode: String = "000000",
        street: String = "Jobs Street, 123",
    ) = CustomerDto(
        firstName = firstName,
        lastName = lastName,
        cpf = cpf,
    ...
    private fun builderCustomerUpdateDto(
        ...
        lastName: String = "JobsUpdate",
        income: BigDecimal = BigDecimal.valueOf(5000.33),
